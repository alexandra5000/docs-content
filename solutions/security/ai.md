...
- [Automatic Migration](/migrate/to-elastic-security/automatic-migration.md): Uses AI to translate rules and dashboards from third-party SIEMs into {{elastic-sec}}'s native format, accelerating SIEM migration.
